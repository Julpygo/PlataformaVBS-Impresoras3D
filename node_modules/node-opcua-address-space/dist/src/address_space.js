...
class AddressSpace {
    ...
    getDataTypeManager() {
        ...
        node_opcua_assert_1.assert(addressSpacePriv.$$extraDataTypeManager, "expecting a $$extraDataTypeManager please make sure ensureDatatypeExtracted is called");
    ...
    findCorrespondingBasicDataType(dataTypeNode) {
        ...
        if (dataTypeNode.nodeId.namespace === 0 && node_opcua_variant_1.DataType[dataTypeNode.nodeId.value]) {
    ...
    findReferenceType(refType, namespaceIndex) {
        ...
        if (refType instanceof node_opcua_nodeid_1.NodeId) {
            ...
            node_opcua_assert_1.assert(typeof refType === "string");
    ...
    generateEventId() {
        ...
        if (!self._eventIdCounter) {
            self._eventIdCounter = crypto_1.randomBytes(20);
    ...
    constructEventData(eventTypeId, data) {
        ...
        // eventId
        node_opcua_assert_1.assert(!data.hasOwnProperty("eventId"), "eventId constructEventData : options object should not have eventId property");
    ...
    getExtensionObjectConstructor(dataType) {
        ...
        node_opcua_assert_1.assert(_dataType.isSupertypeOf(this.findDataType("Structure")));
        ...
        node_opcua_assert_1.assert(_dataType._extensionObjectConstructor, "dataType must have a constructor");
    ...
    browseSingleNode(nodeId, browseDescription, context) {
        ...
        browseDescription.browseDirection = source_1.adjustBrowseDirection(browseDescription.browseDirection, node_opcua_data_model_1.BrowseDirection.Forward);
        /* istanbul ignore next */
    ...
    _coerce_Type(dataType, typeMap, typeMapName, finderMethod) {
        ...
        node_opcua_assert_1.assert(typeMap !== null && typeof typeMap === "object");
        let nodeId;
