...
function constructRegisteredServer(server, isOnline) {
    ...
    const info = node_opcua_crypto_1.exploreCertificate(server.getCertificate());
    ...
    if (serverUri !== server.serverInfo.applicationUri) {
        ...
        console.log(" subjectKeyIdentifier      : ", (_b = info.tbsCertificate.extensions) === null || _b === void 0 ? void 0 : _b.subjectKeyIdentifier);
        console.log(" subjectAltName            : ", (_c = info.tbsCertificate.extensions) === null || _c === void 0 ? void 0 : _c.subjectAltName);
...
class RegisterServerManager extends events_1.EventEmitter {
    ...
    _registerServer(isOnline, outer_callback) {
        var _a;
        node_opcua_assert_1.assert(typeof outer_callback === "function");
                ...
                client.connect(selectedEndpoint === null || selectedEndpoint === void 0 ? void 0 : selectedEndpoint.endpointUrl, (err) => {
                    ...
                    if (err) {
                        ...
                        console.log("RegisterServer to the LDS  has failed during secure connection  " +
                            ...
                            err.message);
                        console.log("LDS endpoint    :", selectedEndpoint === null || selectedEndpoint === void 0 ? void 0 : selectedEndpoint.endpointUrl);
                        console.log("security mode   :", node_opcua_secure_channel_1.MessageSecurityMode[selectedEndpoint.securityMode]);
                        console.log("security policy :", node_opcua_secure_channel_1.coerceSecurityPolicy(selectedEndpoint.securityPolicyUri));
                        // xx debugLog(options);
                        client.disconnect(() => {
