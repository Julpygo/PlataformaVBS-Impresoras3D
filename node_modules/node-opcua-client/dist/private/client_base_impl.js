...
function _verify_serverCertificate(certificateManager, serverCertificate, callback) {
    certificateManager.checkCertificate(serverCertificate, (err, status) => {
        ...
        if (status !== node_opcua_status_code_1.StatusCodes.Good) {
            certificateManager.verifyCertificate(serverCertificate, (err, status) => { });
            ...
            return callback(new Error("server Certificate verification failed with errr " + (status === null || status === void 0 ? void 0 : status.toString())));
        }
        callback();
    });
}
...
class ClientBaseImpl extends node_opcua_common_1.OPCUASecureObject {
    ...
    _cancel_reconnection(callback) {
        // _cancel_reconnection is invovked during disconnection
    ...
    initializeCM() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!fs.existsSync(this.certificateFile)) {
                const applicationUri = this.applicationName;
            ...
            if (this.disconnecting)
                return;
            yield verify_1._verifyCertificate.call(this, "client", this.clientCertificateManager, this.applicationName);
        });
    }
    connect(...args) {
