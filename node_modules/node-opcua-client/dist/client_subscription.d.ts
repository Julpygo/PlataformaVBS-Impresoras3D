...
export interface ClientSubscription extends EventEmitter {
    ...
    monitor(itemToMonitor: ReadValueIdOptions, requestedParameters: MonitoringParametersOptions, timestampsToReturn: TimestampsToReturn, done: (err: Error | null, monitoredItem?: ClientMonitoredItem) => void): void;
    /**
     * @method monitorItems
     ...
     * @async
     */
    monitorItems(itemsToMonitor: ReadValueIdOptions[], requestedParameters: MonitoringParametersOptions, timestampsToReturn: TimestampsToReturn, done: (err: Error | null, monitoredItemGroup?: ClientMonitoredItemGroup) => void): void;
